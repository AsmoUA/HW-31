...
// Я не розумію чому завданні і функції по різному називаються, ще й в них об'єкти передаються
// І без передавання об'єктів зрозуміло що функція написана для конкретного об'єкта
mikeVisits(mike);
mikeVisits(mike);
mikeVisits(mike);
bobVisits(bob);
